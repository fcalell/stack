...
function Root(props: MenuPrimitive.ContextMenuRootProps) {
...
type ContentProps<T extends ValidComponent = "div"> =
	MenuPrimitive.ContextMenuContentProps<T> & { class?: string };
...
type ItemProps<T extends ValidComponent = "div"> =
	MenuPrimitive.ContextMenuItemProps<T> & { class?: string };
...
function Shortcut(props: ComponentProps<"kbd">) {
...
type SeparatorProps<T extends ValidComponent = "hr"> =
	MenuPrimitive.ContextMenuSeparatorProps<T> & { class?: string };
...
type SubTriggerProps<T extends ValidComponent = "div"> =
	MenuPrimitive.ContextMenuSubTriggerProps<T> & {
		class?: string;
...
type SubContentProps<T extends ValidComponent = "div"> =
	MenuPrimitive.ContextMenuSubContentProps<T> & { class?: string };
...
type CheckboxItemProps<T extends ValidComponent = "div"> =
	MenuPrimitive.ContextMenuCheckboxItemProps<T> & {
		class?: string;
		children?: JSX.Element;
	};
...
type GroupLabelProps<T extends ValidComponent = "span"> =
	MenuPrimitive.ContextMenuGroupLabelProps<T> & { class?: string };
...
type RadioItemProps<T extends ValidComponent = "div"> =
	MenuPrimitive.ContextMenuRadioItemProps<T> & {
		class?: string;
		children?: JSX.Element;
	};
