// Wire contract for the client version gate (WS4), shared between
// `src/worker/version-gate.ts` (Cloudflare Worker) and
...
// `.helm/agents/conventions.md`), so the two header names live here,
// outside both.
